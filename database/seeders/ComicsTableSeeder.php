...
class ComicsTableSeeder extends Seeder
{
    ...
    {
        //ciclo for per ogni elemento nei dati comics mi recupera l'elemento comic 
        foreach ($this->datiComics as $comic) {
            ...
            $comicsModel->description = $comic["description"];
            $comicsModel->price = $comic["price"];
            $comicsModel->series = $comic["series"];
